...
metadata$group <- ifelse(metadata$cluster == "11", "Cluster_11", "Rest")

metadata$group <- factor(metadata$group, levels = c("Rest", "Cluster_11"))
...
#res <- results(deseq_dbscan, contrast = c("group", "Cluster_11", "Rest"))
res <- results(deseq_dbscan, contrast = c("group", "Rest", "Cluster_11"))
